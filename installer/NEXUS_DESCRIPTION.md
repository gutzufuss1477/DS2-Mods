...
DS2 Mod Suite is a clean, standalone all-in-one installer and manager for 23 DEATH STRANDING 2: ON THE BEACH mods, with two exclusive Backpack variants.
...
Version 1.8.0 adds Crafting Overhaul 1.3.0, adds the optional Backpack Classic Overlap variant and updates APAS Unified to stable 3.0.0. APAS Unlock All and Episode 2 Early Access are disabled by default. It supports the Steam PC executable version `DS2.exe 1.10.89.0`.
...
- Installs and manages 23 DS2 mods with 24 selectable entries (two exclusive Backpack variants)
...
- Validates 312 settings across 21 individual INI files
...
- Crafting Overhaul 1.3.0 - 120 individual item unlock choices, optional Free Crafting, Omnireflector Boots and equipment durability settings
...
Crafting Overhaul 1.3.0 supports 120 per-item unlock choices. The item list is shown under advanced settings; Free Crafting and durability changes are disabled by default. The manager preserves existing item choices and INI comments on update.
