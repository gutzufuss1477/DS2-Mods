...
Sneaky Sam blendet Fracht auf Sams vier Körper-Slots aus:
...
Die Fracht bleibt vollständig erhalten und funktioniert normal. Wird sie wieder auf den Rucksack oder einen anderen nicht betroffenen Platz verschoben, wird sie durch den normalen Spielpfad wieder sichtbar.
...
Validiert für **DS2.exe v1.10.89.0**.
