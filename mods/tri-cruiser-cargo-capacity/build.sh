...
lld-link /nologo /dll /machine:x64 /entry:DllMain /nodefaultlib /timestamp:0 /dynamicbase /nxcompat /highentropyva /noimplib /out:"$ROOT/release/DS2_TriCruiser_CargoCapacity_v1.1.0.asi" "$ROOT/build/tri_cruiser_cargo_capacity.obj" "$ROOT/build/capacity_stubs.obj" "$ROOT/build/kernel32.lib"
