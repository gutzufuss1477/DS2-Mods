# Lost Cargo Likes Booster v1.0.0
...
The plugin remains active until game exit. It has no time limit or hit limit. It is guarded to the validated DS2 build and lost-cargo writer path; regular orders and other Like sources are excluded.
