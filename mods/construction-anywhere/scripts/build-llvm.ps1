...
$object = Join-Path $out 'construction_anywhere.obj'
& $clang --target=x86_64-pc-windows-msvc /nologo /c /O2 /Ob0 /GS- /GR- /EHs-c- /Zl /Oi /W4 /WX /clang:-fno-builtin "/I$root\src" /TP "/Fo$object" "$root\src\construction_anywhere.cpp"
if ($LASTEXITCODE) { throw 'compile failed' }

$asi = Join-Path $out 'ds2_construction_anywhere.asi'
...
Copy-Item -LiteralPath (Join-Path $root 'config\ds2_construction_anywhere.ini') -Destination (Join-Path $out 'ds2_construction_anywhere.ini') -Force
