...
$obj = Join-Path $out 'infrastructure_one_unit.obj'
& $clang --target=x86_64-pc-windows-msvc /nologo /c /O2 /Ob0 /GS- /GR- /EHs-c- /Zl /Oi /W4 /WX /clang:-fno-builtin "/I$root\src" /TP "/Fo$obj" "$root\src\infrastructure_one_unit.cpp"
if ($LASTEXITCODE) { throw 'compile failed' }

$asi = Join-Path $out 'ds2_infrastructure_one_unit.asi'
...
Copy-Item "$root\config\ds2_infrastructure_one_unit.ini" (Join-Path $out 'ds2_infrastructure_one_unit.ini') -Force
