...
DWORD WINAPI init(void*){
 ...
 Text session;session.add("DS2 Crafting Unlocks 0.2.0-alpha | fabrication + backpack | exact-build gate | pid=");session.dec(GetCurrentProcessId());session.add(" tick=");session.dec(GetTickCount64());log(session);
