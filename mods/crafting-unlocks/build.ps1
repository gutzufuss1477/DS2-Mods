...
try {
    ...
    & $linker '/dll' '/entry:DllMain' '/machine:x64' '/nodefaultlib' '/dynamicbase' '/nxcompat' '/opt:ref' '/opt:icf' '/out:release/ds2_crafting_unlocks.asi' '/implib:build/ds2_crafting_unlocks.lib' 'build/mod.obj' 'build/kernel32.lib'
