...
$object = Join-Path $out 'odradek_scan.obj'
& $clang --target=x86_64-pc-windows-msvc /nologo /c /O2 /Ob0 /GS- /GR- /EHs-c- /Zl /Oi /W4 /WX /clang:-fno-builtin /clang:-mcx16 "/I$root\src" /TP "/Fo$object" "$root\src\odradek_scan.cpp"
if ($LASTEXITCODE) { throw 'compile failed' }

$asi = Join-Path $out 'ds2_odradek_scan.asi'
