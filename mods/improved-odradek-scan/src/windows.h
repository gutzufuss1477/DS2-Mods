#pragma once
#ifndef DS2_ODRADEK_SCAN_WINDOWS_H
#define DS2_ODRADEK_SCAN_WINDOWS_H
...
u64 WINAPI GetTickCount64(void);
...
void WINAPI AcquireSRWLockShared(SRWLOCK_X64*);
void WINAPI ReleaseSRWLockShared(SRWLOCK_X64*);
void WINAPI AcquireSRWLockExclusive(SRWLOCK_X64*);
void WINAPI ReleaseSRWLockExclusive(SRWLOCK_X64*);
}
